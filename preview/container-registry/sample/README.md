...
1) Create or update a toolchain to include:
   ...
   ![Toolchain overview](https://github.ibm.com/one-pipeline/docs/blob/master/assets/common-tekton-tasks/container-registry/containerize/container-registry-sample-toolchain-overview.png)
...
2) Add the definitions:
   ...
   ![Tekton pipeline definitions](https://github.ibm.com/one-pipeline/docs/blob/master/assets/common-tekton-tasks/container-registry/containerize/container-registry-sample-tekton-pipeline-definitions.png)
...
3) Add the environment properties:
   ...
   ![Tekton pipeline environment properties](https://github.ibm.com/one-pipeline/docs/blob/master/assets/common-tekton-tasks/container-registry/containerize/container-registry-sample-tekton-pipeline-environment-properties.png)

4) Create a manual trigger to start the sample listener

   ![Tekton pipeline sample trigger](https://github.ibm.com/one-pipeline/docs/blob/master/assets/common-tekton-tasks/container-registry/containerize/container-registry-sample-tekton-pipeline-sample-triggers.png)
